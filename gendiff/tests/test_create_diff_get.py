...
def test_create_diff_get():
    text_1 = read_file('gendiff/tests/fixtures/file1.json')
    text_2 = read_file('gendiff/tests/fixtures/file2.json')
    obj_format_1 = data_format('gendiff/tests/fixtures/file1.json')
    obj_format_2 = data_format('gendiff/tests/fixtures/file2.json')
